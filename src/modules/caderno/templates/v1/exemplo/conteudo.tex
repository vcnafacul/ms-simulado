...
%
% Teste de esforço opcional: para exercitar mais quebras de coluna e de
% página — o que testa melhor o \needspace e o rodapé com \thepage —
% duplique o \input{conteudo} no main.tex. As seis questões abaixo já
% cobrem os riscos de layout descritos no comentário de cada uma.
